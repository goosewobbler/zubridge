...
switch (platform) {
    ...
    switch (arch) {
      case 'x64':
        localFileExisted = existsSync(
          join(__dirname, 'zubridge-middleware.win32-x64-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'ia32':
        localFileExisted = existsSync(
          join(__dirname, 'zubridge-middleware.win32-ia32-msvc.node')
        )
        try {
          if (localFileExisted) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'zubridge-middleware.win32-arm64-msvc.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'darwin':
    ...
    switch (arch) {
      ...
      case 'arm64':
        localFileExisted = existsSync(
          join(__dirname, 'zubridge-middleware.darwin-arm64.node')
        )
        try {
          if (localFileExisted) {
  ...
  case 'linux':
    switch (arch) {
      case 'x64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-x64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-x64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-arm64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-arm64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'arm':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-arm-musleabihf.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-arm-gnueabihf.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 'riscv64':
        if (isMusl()) {
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-riscv64-musl.node')
          )
          try {
            if (localFileExisted) {
          ...
          localFileExisted = existsSync(
            join(__dirname, 'zubridge-middleware.linux-riscv64-gnu.node')
          )
          try {
            if (localFileExisted) {
      ...
      case 's390x':
        localFileExisted = existsSync(
          join(__dirname, 'zubridge-middleware.linux-s390x-gnu.node')
        )
        try {
          if (localFileExisted) {
