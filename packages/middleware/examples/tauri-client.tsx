...
export function App(): React.Element {
  ...
  const counter = useZubridgeStore<number>((state: AppState) => state.counter);
  const isDarkTheme = useZubridgeStore<boolean>((state: AppState) => state.theme?.is_dark ?? false);
    ...
    <div className="app">
      ...
      <main>
        ...
        <div className="info-panel">
          ...
          <ul>
            <li>Actions are dispatched from the frontend using useZubridgeDispatch</li>
            <li>The Tauri backend processes these actions through the middleware</li>
