...
// UI components
import { Button } from '@zubridge/ui';
import { ThemeToggle } from '@zubridge/ui';
import { Header } from '@zubridge/ui';
...
function MinimalApp() {
  ...
  return (
    <div className="min-h-screen">
      <Header
        windowTitle="Redux Minimal Window"
        appName="Zubridge - Redux Minimal"
