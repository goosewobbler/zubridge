...
export const actions = {
  ...
  'COUNTER:DOUBLE:SLOW': counterSlice.actions.doubleValueSlow,
  'COUNTER:HALVE:SLOW': counterSlice.actions.halveValueSlow,
  'COUNTER:DOUBLE': counterSlice.actions.doubleValue,
  'COUNTER:HALVE': counterSlice.actions.halveValue,
