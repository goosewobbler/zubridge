import type { ReduxBridge, ZustandBridge } from '@zubridge/electron/main';
 ...
 */
export const createBridge = async (): Promise<AnyBridge> => {
  ...
  switch (mode) {
    case ZubridgeMode.ZustandBasic: {
      ...
      return createBasicBridge(getBasicStore());
    }
    ...
    case ZubridgeMode.ZustandHandlers: {
      ...
      return createHandlersBridge(getHandlersStore());
    }
    ...
    case ZubridgeMode.ZustandReducers: {
      ...
      return createReducersBridge(getReducersStore());
    }
    ...
    case ZubridgeMode.Redux: {
      ...
      return createReduxBridge(reduxStore);
    }
    ...
    case ZubridgeMode.Custom: {
      ...
      return createCustomBridge(customStore);
    }
